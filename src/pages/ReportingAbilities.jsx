  ...
  return (
    <div>
      ...
      <div className='mt-10 w-[600px] '>
        <h2 className='mb-4 text-2xl font-extrabold leading-none tracking-tight text-gray-900 md:text-2xl lg:text-2xl'>This web page enables <mark className='px-2 text-white bg-gray-700 rounded dark:bg-gray-700'>employees</mark> to submit <mark className='px-2 text-white bg-gray-700 rounded dark:bg-gray-700'>Reports.</mark></h2>
      </div>
      ...
      <div className='w-[800px] mt-10'>
        ...
        <div>
          <form>
            <div class="w-full p-2 mb-4 border border-gray-200 rounded-lg bg-gray-50 dark:bg-gray-700 dark:border-gray-600">
              <label for="input-group-1" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Your Name</label>
              <div class="relative mb-6">
                <input type="text" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full  p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Emp Name" />
              </div>
              ...
              <div class="px-4 py-2 bg-white rounded-t-lg dark:bg-gray-800">
                ...
                <textarea id="comment" rows="4" class="w-full px-0  text-gray-900 bg-white border-0 dark:bg-gray-800 focus:ring-0 dark:text-white dark:placeholder-gray-400 outline-0" placeholder="Write a report..." required></textarea>
              </div>
